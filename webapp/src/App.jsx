      ...
      <div className="relative overflow-hidden gradient-primary rounded-3xl p-6 text-white shadow-glass">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className={`font-medium text-white/80 mb-1 ${responsive.isDesktop ? 'text-base' : 'text-sm'}`}>Painel Administrativo</h2>
              <p className={`font-bold ${responsive.isDesktop ? 'text-3xl' : 'text-2xl'}`}>Visão Geral 🚀</p>
            </div>
            <div className={`bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center ${responsive.isDesktop ? 'w-16 h-16' : 'w-12 h-12'}`}>
              <Sparkles className={responsive.isDesktop ? 'w-8 h-8' : 'w-6 h-6'} />
            </div>
          </div>
          
          <div className={`grid gap-3 mt-6 ${responsive.isDesktop ? 'grid-cols-4' : 'grid-cols-2'}`}>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 text-white/70 text-xs mb-2">
                <Package className="w-3.5 h-3.5" />
                <span>Pacotes Hoje</span>
              </div>
              <p className={`font-black ${responsive.isDesktop ? 'text-4xl' : 'text-3xl'}`}>{adminStats?.packages_total || 0}</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2 text-white/70 text-xs mb-2">
              ...
              <p className={`font-black text-green-300 ${responsive.isDesktop ? 'text-4xl' : 'text-3xl'}`}>{adminStats?.delivered || 0}</p>
            </div>
            {responsive.isDesktop && (
              <>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <p className="text-4xl font-black text-blue-300">{adminStats?.active_deliverers || 0}</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-2 text-white/70 text-xs mb-2">
                  ...
                  <p className="text-4xl font-black text-yellow-300">{adminStats?.active_sessions || 0}</p>
                </div>
              </>
            )}
          </div>
            ...
            <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
              {[
                ...
                <button
                  ...
                  className={`w-full px-4 py-3 rounded-lg transition-all flex items-center gap-3 font-medium text-sm group ${
                    activeTab === item.id
                ...
                >
                  ...
                  {activeTab === item.id && <div className="ml-auto w-1 h-6 bg-primary-600 rounded-full" />}
                </button>
              ))}
            </nav>
